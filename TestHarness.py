...
def tests_to_run(forwarder):
    ...
    from tests import RandomDelayTest, SackRandomDelayTest
    from tests import RandomDuplicationTest, SackRandomDuplicationTest
    from tests import RandomShuffleTest, SackRandomShuffleTest
    ...
    SackRandomDuplicationTest.SackRandomDuplicationTest(forwarder, "README")
    RandomDelayTest.RandomDelayTest(forwarder, "README")
    SackRandomDelayTest.SackRandomDelayTest(forwarder, "README")
